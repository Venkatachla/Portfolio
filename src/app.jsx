...
const App = () => {
  ...
  const roles = ["Frontend Development", "Fullstack Development", "Software Development", "Mobile App Development"];
    ...
    <div className="bg-slate-900 text-white font-inter">
      <style>
        ...
        .gradient-button:hover {
            background-image: linear-gradient(to left, #8A2BE2, #FF1493);
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {[
                ...
                },
                {
                  ...
                  live: 'https://drive.google.com/file/d/1lbd9GLPtQkJw28_8fyWX_PPMg0x-lW95/view?usp=sharing'
                },
                {
